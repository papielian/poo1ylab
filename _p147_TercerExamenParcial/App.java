...
public class App extends JFrame implements ActionListener {
    ...
    public App() {
        ...
        mbrJugador.add(menuArchivo);
        menuAyuda = new JMenu("Ayuda");
        mbrJugador.add(menuAyuda);
        ...
        lblNombre = new JLabel("Nombre (MAYUSCULAS)");
        ...
        lblSexo = new JLabel("Sexo (F/M)");
        lblSexo.setHorizontalAlignment(SwingConstants.RIGHT);
        txtSexo = new JTextField();
        pnlDatos.add(lblSexo);
        pnlDatos.add(txtSexo);

        lblEstadoCivil = new JLabel("Estado Civil (Soltero/Casado)");
        ...
        lblTotalSalario = new JLabel("Salario Total");
        lblTotalSalario.setHorizontalAlignment(SwingConstants.RIGHT);
        ...
        lblTotalMujeres.setHorizontalAlignment(SwingConstants.RIGHT);
        txtTotalMujeres = new JTextField();
        txtTotalMujeres.setEditable(false);
        pnlDatos.add(lblTotalMujeres);
        pnlDatos.add(txtTotalMujeres);

        lblTotlaHombres = new JLabel("Total de Hombres");
        lblTotlaHombres.setHorizontalAlignment(SwingConstants.RIGHT);
        txtTotalHombres = new JTextField();
        txtTotalHombres.setEditable(false);
        pnlDatos.add(lblTotlaHombres);
        pnlDatos.add(txtTotalHombres);

        lblTotalSolteros = new JLabel("Total de Solteros");
        lblTotalSolteros.setHorizontalAlignment(SwingConstants.RIGHT);
        ...
        lblTotalCasados = new JLabel("Total de Casados");
        lblTotalCasados.setHorizontalAlignment(SwingConstants.RIGHT);
